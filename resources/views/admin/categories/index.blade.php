...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="klik untuk menambah kategori">
            <a href="{{ route('category.create') }}" class="btn btn-light-primary">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('category.edit',['category'=>$category]) }}" class="btn btn-light-success btn-sm">Ubah</a>
                            <button type="button" class="btn btn-light-info btn-sm" data-bs-toggle="modal" data-bs-target="#modalDetail-{{ $key }}">
                                Detail
                            </button>
                            <form  method="post" class="d-inline" onsubmit="btnDelete('category',{{ $category->id }})">
                                @csrf
                                @method('delete')
