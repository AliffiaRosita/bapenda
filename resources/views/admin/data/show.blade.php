    ...
    <div class="modal-dialog modal-lg modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <div class="row ">
                    @foreach ($data->dataFiles as $key=> $file)
                    <div class="col-md-3 mb-3">{{ $key+1 }}</div>
                                <div class="col-md-3 mb-3">{{ $file->title }}</div>
                                <div class="col-md-3 mb-3">{{ $data->title }}</div>
                                <div class="col-md-3 mb-3"><a href="{{ route('data.download',['dataFile'=>$file]) }}"  class="btn btn-sm btn-success">Unduh</a></div>
