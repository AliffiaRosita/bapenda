    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <form
                        action="{{ route('information.update',['information'=>$information]) }}"
                        ...
                        <div class="col-md-12">
                            <div class="mb-10">
                                ...
                                <input type="text" value="{{ old('nama',$information->title) }}"
                            ...
                            <div class="mb-10">
                                ...
                                <div class="form-check form-check-custom form-check-solid mb-5">
                                    ...
                                    <input class="form-check-input me-3 " name="type"
                                        {{ old('type', $information->type) == 'article'? 'checked':'disabled' }} type="radio"
                                ...
                                <div class="form-check form-check-custom form-check-solid mb-5">
                                    ...
                                    <input class="form-check-input me-3"
                                        {{ old('type',$information->type) == 'file'? 'checked':'disabled' }} required
                            ...
                            <div class="col-md-12">
                                <div class="mb-10">
                                    ...
                                    <textarea name="isi" id="summernote" required class=" form-control"
                                        style="height: 300px">{{ $information->infoArticle->desc ?? '' }}</textarea>
                        ...
                        @foreach ($file as $key=>$item)
                            <div class="col-5 bg-light p-3 mb-3 me-3" id="file-{{ $item->id }}">
                                <i class="bi bi-file-earmark-pdf-fill text-danger"></i> <a href="{{ route('information.download',['infoFile'=>$item]) }}">Download {{ $item->title }} </a>

                                    <i class="bi bi-x-lg icon-click float-end" onclick="deleteFile({{ $item->id }}, 'information')"></i>
                            </div>
                            @endforeach
                        </div>
                </div>
