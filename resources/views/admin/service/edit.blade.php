            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('service.update',$service) }}" enctype="multipart/form-data" method="post">
                        @csrf
                        @method('put')
                        <h3 class="mb-5">Ubah Data Layanan</h3>

                        <div class="col-md-7">
                            <div class="mb-10">
                                <label for="name" class="required form-label">Nama Layanan</label> <br>
                                <input type="text" value="{{ old('nama',$service->title) }}" class=" @error('nama') is-invalid  @enderror form-control form-control" name="nama" />
                                @error('nama')
                        ...
                        <div class="col-md-7">
                            <div class="mb-10">
                                ...
                                <textarea name="deskripsi" id="deskripsi" class="@error('deskripsi') is-invalid  @enderror form-control form-control" cols="30" rows="5">
                                    {{ old('deskripsi',$service->desc) }}</textarea>
                                @error('deskripsi')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-7">
                            <div class="mb-10">
                                ...
                                <input type="text" name="url" value="{{ old('url',$service->url) }}" id="url" class="@error('url') is-invalid  @enderror form-control form-control" placeholder="https://example.com" >
                                @error('url')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-7">
                            <div class="mb-10">
                                <label for="img" class="required form-label">Gambar Layanan</label> <small>(Kosongkan input bila tidak mengubah gambar)</small> <br>
                                <img id="imgThumb" src="{{ asset($service->icon) }}" style="width:200px" alt="institution" />
