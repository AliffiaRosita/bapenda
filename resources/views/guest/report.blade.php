        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">{{$report->title}}</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="breadcrumb-wrap">
        <div class="container">
            <ol class="breadcrumb d-flex">
                <li class="breadcrumb-item"><a href="index.html">Laporan Berkala</a></li>
                <li class="breadcrumb-item"><a href="">{{$report->title}}</a></li>
            </ol>
            <!-- End .row-->
        </div>
    </div>
 ...
 <section class="about about-3" style="padding-top:50px" id="about-3">
        <div class="container">
            ...
            <table class="table table-striped table-hover text-center">
                ...
                @foreach ($reportFile as $key=>$item)
                <tr>
                    <td>{{$key+1}}</td>
                    <td>{{$item->title}}</td>
                   @php
