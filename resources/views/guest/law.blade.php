        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">{{$law->title}}</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="breadcrumb-wrap">
        <div class="container">
            <ol class="breadcrumb d-flex">
                <li class="breadcrumb-item"><a href="index.html">Produk Hukum</a></li>
                <li class="breadcrumb-item"><a href="">{{$law->title}}</a></li>
            </ol>
            <!-- End .row-->
        </div>
    </div>
