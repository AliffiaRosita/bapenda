...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="klik untuk menambah daftar layanan">
            <a href="{{ route('serviceList.create',['serviceProgram'=> $serviceProgram]) }}" class="btn btn-light-primary">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('serviceList.edit',['serviceList'=>$serviceList]) }}" class="btn btn-light-success btn-sm">Ubah</a>
                    ...
                    @include('admin.service_program.service_list.show')
                    @endforeach
                </tbody>
                <!--end::Table body-->
            </table>
