...
<div class="container">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('infographic.store') }}" enctype="multipart/form-data" method="post">
                        @csrf
                        <h3 class="mb-5">Tambah Data {{ $title }}</h3>
                        <div class="col-md-12">
                            <div class="mb-10">
                                <label for="name" class="required form-label">Keterangan Gambar</label> <br>
                                <input type="text" value="{{ old('keterangan') }}" class=" @error('keterangan') is-invalid  @enderror form-control form-control" name="keterangan" />
                                @error('keterangan')
                        ...
                        <div class="col-md-7">
                            <div class="mb-10">
                                <label for="exampleFormControlInput1" class="required form-label">Gambar </label> <br>
