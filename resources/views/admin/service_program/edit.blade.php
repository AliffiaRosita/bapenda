...
<div class="container">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('serviceProgram.update',$serviceProgram) }}" enctype="multipart/form-data" method="post">
                        @csrf
                        @method('put')
                        ...
                        <div class="col-md-12">
                            <div class="mb-10">
                                ...
                                <input type="text" value="{{ old('kota',$serviceProgram->title) }}" class=" @error('kota') is-invalid  @enderror form-control form-control" name="kota" />
                                @error('kota')
                        ...
                        <div class="col-md-12">
                            <div class="mb-10">
                                ...
                                <textarea name="deskripsi" id="summernote"  class="@error('deskripsi') is-invalid  @enderror form-control" style="height: 300px" >
                                    {{ old('deskripsi',$serviceProgram->desc) }}</textarea>
                                @error('deskripsi')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
