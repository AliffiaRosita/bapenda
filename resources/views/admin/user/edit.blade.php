...
<div class="card mb-5 mb-xl-10">
    ...
    <div id="kt_account_profile_details" class="collapse show">
        <!--begin::Form-->
        <form id="kt_account_profile_details_form" class="form"  method="post" action="{{route('user.update',['user'=>$user])}}" enctype="multipart/form-data">
            @csrf
            @method('put')
            <!--begin::Card body-->
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        <!--begin::Image input-->
                        @php
                        if ($user->admin->img!= null) {
                            $image=str_replace('\\','/',$user->admin->img);
                        }else{
                            $image = 'admin/assets/media/avatars/blank.png';
                        }
                        @endphp
                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{asset("admin/assets/media/avatars/blank.png")}}')">
                            ...
                            <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{asset($image)}}')"></div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="nama" class="  @error('nama') is-invalid  @enderror form-control form-control-lg form-control-solid"  value="{{ old('nama',$user->admin->name) }}" />
                            @error('nama')
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="email"  name="email" class=" @error('email') is-invalid  @enderror  form-control form-control-lg form-control-solid"  value="{{ old('email',$user->email) }}" />
                            @error('email')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-7">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label  fw-bold fs-6">Password Baru <br> <small class="fw-normal">(Kosongkan input bila tidak mengubah password)</small></label>
