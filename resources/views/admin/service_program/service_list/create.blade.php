...
<div class="container">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('serviceList.store',['serviceProgram'=> $serviceProgram]) }}" enctype="multipart/form-data" method="post">
                        @csrf
                        ...
                        <div class="col-md-12">
                            <div class="mb-10">
                                ...
                                <input type="text" value="{{ old('layanan') }}" class=" @error('layanan') is-invalid  @enderror form-control form-control" name="layanan" />
                                @error('layanan')
