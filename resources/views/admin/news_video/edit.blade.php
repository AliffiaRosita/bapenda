...
<div class="container">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('newsVideo.update',['newsVideo'=>$newsVideo]) }}" enctype="multipart/form-data" method="post">
                        @csrf
                        @method('put')
                        ...
                        <div class="col-md-12">
                            <div class="mb-10">
                                ...
                                <input type="text" value="{{ old('judul',$newsVideo->title) }}" class=" @error('judul') is-invalid  @enderror form-control form-control" name="judul" />
                                @error('judul')
                        ...
                        <div class="col-md-12">
                            <div class="mb-10">
                                ...
                                <textarea name="deskripsi" id="summernote"  class="@error('deskripsi') is-invalid  @enderror form-control" style="height: 300px" >
                                    {{ old('deskripsi',$newsVideo->desc) }}</textarea>
                                @error('deskripsi')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-10">
                                ...
                                <input type="text" class=" @error('video') is-invalid  @enderror form-control form-control" name="video" id="gallery-photo-add" value="{{ old('video',$newsVideo->url) }}" placeholder="cth: https://www.youtube.com/embed/zaTS2Mf8"/>
                                @error('video')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
