                        ...
                        <form action="{{ route('newsVideo.store') }}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="col-md-12">
                                <div class="mb-10">
                                    ...
                                    <textarea name="deskripsi" id="summernote" class="@error('deskripsi') is-invalid  @enderror form-control"
                                        style="height: 300px">
                            ...
                            <div class="col-md-12">
                                <div class="mb-10">
                                    <label for="exampleFormControlInput1" class="required form-label">Sampul / Thumbnail
                                    </label> <br>
                                    <img id="imgThumb" src="{{ asset('admin/assets/media/illustrations/sigma-1/4.png') }}"
                                        style="width:200px" alt="banner" />
                                    <input type="file"
                                        class=" @error('thumbnail') is-invalid  @enderror form-control form-control-solid"
                                        name="thumbnail" id="imgInp" accept="image/*" />
                                    @error('thumbnail')
                                        <div class="invalid-feedback d-block">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-10">
                                    ...
                                    <input type="text" value="{{ old('video') }}"
                                        class=" @error('video') is-invalid  @enderror form-control form-control"
                                        name="video" id="gallery-photo-add"
                                        placeholder="cth: https://www.youtube.com/embed/zaTS2Mf8" />
                                    @error('video')
                                        <div class="invalid-feedback d-block">
                                            {{ $message }}
                                        </div>
