                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('news.store') }}" enctype="multipart/form-data" method="post">
                                    ...
                                    <select class="form-control select2" id="kt_select2_3" name="kategori[]"
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                @if (old('kategori'))
                                                    @foreach (old('kategori') as $oldCategory)
                            ...
                            <div class="col-md-12">
                                <div class="mb-10">
                                    <label for="img" class=" form-label">Foto Dokumentasi <small>(Dapat upload lebih
                                            dari 1 foto)</small></label> <br>
                                    <input type="file"
                                        class=" @error('gambar') is-invalid  @enderror form-control form-control-solid"
                                        name="gambar[]" accept="image/*" id="gallery-photo-add" multiple />
                    ...
                    for (i = 0; i < filesAmount; i++) {
                        ...
                        reader.onload = function(event) {
                            $($.parseHTML('<img>')).attr('src', event.target.result).addClass(
                                'img-multiple').appendTo(placeToInsertImagePreview);
                        }
